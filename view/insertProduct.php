...
<main>
        ...
        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
          ...
          <h5 class="profileText">ProductName:</h5> 
          <input type="text" id="productName" name="productName" class="profileText"> <br>
          <h5 class="profileText">ProductText:</h5> 
          <input type="text" id="productText" name="productText" class="profileText"> <br>
          <h5 class="profileText">Collection:</h5> 
          <input class="profileText" type="text" id="collection" name="collection"> <br>
          <h5 class="profileText">Price:</h5>
          <input type="number" min="1" id="price" name="price" class="profileText"> <br> <br>

          <input class="profileButton" type="submit" name="insertProductButton" value="INSERT PRODUCT">
