...
<main>
	...
	<form method="post" action="">
          ...
          <input class="profileText" type="text" id="collection" name="collection" value="<?=$product['Collection']?>"> <br>
          <h5 class="profileText"s>Price:</h5>
          <input class="profileText" type="number" min="1" id="price" name="price" value="<?=$product['Price']?>"> <br> <br>

          <input class="profileButton" type="submit" name="updateProductButton" value="UPDATE PRODUCT">
